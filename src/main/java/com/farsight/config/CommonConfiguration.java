...
public class CommonConfiguration implements ICommonConfig
{
    ...
    public JsonObject serialize()
    {
        ...
        entry7.addProperty("desc:",
            "Enables a custom chunk manager, allowing to set higher view distances than 32 and smoothing out chunk loading from the server through caching. Can be disabled for compatibility issues, default true. (false) = vanilla");
